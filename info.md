...
直接按照这个项目的架构和ui  ~/testworkspace/test04-iptv/iptv_sxs_system/



写个系统  基于ragflow  https://github.com/infiniflow/ragflow/tree/v0.24.0



S

## 4 slug: /http_api_reference sidebar_custom_props: { categoryIcon: LucideGlobe }
...
- `"metadata_condition"`: (*Body parameter*), `object`
  ...
  - `"conditions"`: (*Body parameter*), `array`
    ...
    - `"name"`: `string` - The metadata field name to filter by, e.g., `"author"`, `"company"`, `"url"`. Ensure this parameter before use. See [Set metadata](http://159.138.146.41/guides/dataset/set_metadata.md) for details.
...
:::info IMPORTANT You can include custom parameters in the request body, but first ensure they are defined in the [Begin](http://159.138.146.41/guides/agent/agent_component_reference/begin.mdx) component. :::
...
![img](http://159.138.146.41/assets/svg/langfuse-VsUws2FT.svg)Langfuse
